...
void ImageConversions_convert_yuv_to_rgb(const unsigned char *__restrict yuv_frame_pointer,
                        unsigned char *__restrict rgb_frame_pointer,
                        struct FrameDimensions *frame_dimensions);

void ImageConversions_convert_yuv_to_gray(const unsigned char *__restrict yuv_frame_pointer,
